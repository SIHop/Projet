...
public class EnvoiePatient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Logo Priceton.PNG"))); // NOI18N
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 0, 0), 1, true), "Consultation d'un dossier médical radiologique - © MedSIR, 2017", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Serif", 0, 14), new java.awt.Color(102, 0, 0))); // NOI18N
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 0, 0), 1, true), "Consultation d'un dossier médical radiologique - © MedSIR, 2017", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Serif", 0, 14), new java.awt.Color(102, 0, 0))); // NOI18N

        jButton8.setBackground(new java.awt.Color(255, 255, 255));
        jButton8.setFont(new java.awt.Font("Serif", 1, 30)); // NOI18N
        ...
        nom1.setFont(new java.awt.Font("Serif", 0, 30)); // NOI18N
        nom1.setForeground(new java.awt.Color(102, 0, 0));
        nom1.setText("Numéro d'identifiant unique du patient:");
        ...
        jRadioButton3.setFont(new java.awt.Font("Serif", 0, 30)); // NOI18N
        ...
        jRadioButton4.setFont(new java.awt.Font("Serif", 0, 30)); // NOI18N
        ...
        jComboBox4.setFont(new java.awt.Font("Serif", 0, 30)); // NOI18N
        ...
        jComboBox5.setFont(new java.awt.Font("Serif", 0, 30)); // NOI18N
        ...
        jComboBox6.setFont(new java.awt.Font("Serif", 0, 30)); // NOI18N
        jComboBox6.setForeground(new java.awt.Color(102, 0, 0));
        ...
        jTable4.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "IPP", "Nom", "Prenom", "Date de naissance", "Sexe", "Adresse", "Ville", "Code Postal"
            }
        ));
        ...
        jButton5.setFont(new java.awt.Font("Serif", 0, 25)); // NOI18N
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addComponent(jTextField6, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addComponent(nom1)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        DPI p = new DPI(nom, nom, prenom, adresse, IPP iPP, dateDeNaissance, null, null, null, null, null, sexe);

        if (!jTextField4.getText().equals("")) {
            try {
                patient = p.recherchePatientParID(IPP);
            } catch (Exception ex) {
                Logger.getLogger(ConsultationDMR.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        if (jTextField4.getText().equals("") & jTextField6.getText().equals("") & !jTextField5.getText().equals("") & sexe.equals("")) {
            try {
                listePatient = p.recherchePatientParNom(nom);
            } catch (Exception ex) {
                Logger.getLogger(ConsultationDMR.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            for (int j = 0; j < listePatient.size(); j++) {
                jTable4.setValueAt(listePatient.get(j).getId(), i, 0);
                jTable4.setValueAt(listePatient.get(j).getNom(), i, 1);
                jTable4.setValueAt(listePatient.get(j).getPrenom(), i, 2);
                jTable4.setValueAt(listePatient.get(j).getDateDeNaissance(), i, 3);
                jTable4.setValueAt(listePatient.get(j).getGenre(), i, 4);
                jTable4.setValueAt(listePatient.get(j).getAdresse(), i, 5);
                jTable4.setValueAt(listePatient.get(j).getVille(), i, 6);
                jTable4.setValueAt(listePatient.get(j).getCP(), i, 7);
                i++;
            }
        ...
        if (jTextField4.getText().equals("") & sexe.equals("") & !jTextField5.getText().equals("") & !jTextField6.getText().equals("")) {
            try {
                listePatient = p.recherchePatientParNomPrenom(nom, prenom);
            } catch (Exception ex) {
                Logger.getLogger(ConsultationDMR.class.getName()).log(Level.SEVERE, null, ex);
            }
            DefaultTableModel model2 = (DefaultTableModel) jTable4.getModel();
        ...
        if (jTextField4.getText().equals("") & !sexe.equals("") & !jTextField5.getText().equals("") & !jTextField6.getText().equals("")) {
            try {
                listePatient = p.recherchePatient(nom, prenom, date, sexe);
            } catch (Exception ex) {
                Logger.getLogger(ConsultationDMR.class.getName()).log(Level.SEVERE, null, ex);
            }
            DefaultTableModel model2 = (DefaultTableModel) jTable4.getModel();
    ...
    private void jTable4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable4MouseClicked
        ...
        try {
            patient = listePatient.get(0).recherchePatientParID(IPP);
            System.out.println("patient selectionné : " + patient.getId() + " " + patient.getNom() + " " + patient.getPrenom());
        } catch (Exception ex) {
            Logger.getLogger(ConsultationDMR.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        if (!jTextField2.getText().equalsIgnoreCase("") && !jTextField3.getText().equalsIgnoreCase("")) {
            ...
            if (patient != null) {
                try {
                    ...
                    Logger.getLogger(EnvoiePatient.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        } else {
        }
