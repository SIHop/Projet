 ...
 */
public class ServiceCliniqueActeE extends javax.swing.JFrame {
    ...
    private ArrayList<String> lcode =new ArrayList<>();
    private ArrayList<String> lLibel =new ArrayList<>();
    
    public ServiceCliniqueActeE(Personnel p, DPI dpi,String numSej,ArrayList<DPI> listeDPI) {
        initComponents();
        this.p=p;
        this.dpi=dpi;
...
//remplissage du combobox avec les types d'actes
        ...
        for(Code code :Code.values()){
            this.lcode.add(code.toStringCode());
            this.lLibel.add(code.toStringBis());
            
        }
        for(String ll:this.lLibel){
            this.jComboBox1.addItem(ll);
        }
    ...
    private void jLabel17MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel17MouseClicked
        if((this.jTextArea1.getText() != null )&&(this.jComboBox1.getSelectedItem() !=null)){
            //On ajoute la actes au sejour et on met a jours la db
            ...
            if(this.jComboBox2.getSelectedItem().toString()=="DIAGNOSTIQUE"){
                    acte = new Acte(idFiche,Code.valueOf(this.lcode.get(position)),coef,obs,TypeActe.DIAGNOSTIQUE);
                }
            else{acte = new Acte(idFiche,Code.valueOf(this.lcode.get(position)),coef,obs,TypeActe.DIAGNOSTIQUE);}
            
            ArrayList<Acte> listActe = new ArrayList<>();
            listActe.add(acte);
            FicheDeSoins fiche = new FicheDeSoins(idFiche,listActe,null,null,this.p,dateP,this.numSej);
            ...
            DAOFactory.getActeDAO().create(acte);
