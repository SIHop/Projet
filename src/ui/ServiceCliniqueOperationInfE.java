...
import static db.GestionnaireDB.DAOFactory.getFicheDeSoinsDAO;
 ...
 */
public class ServiceCliniqueOperationInfE extends javax.swing.JFrame {
    ...
    public ServiceCliniqueOperationInfE(Personnel p, DPI dpi,String numSej,ArrayList<DPI> listeDPI) {
        initComponents();
        this.p=p;
        this.dpi=dpi;
...
//remplissage du combobox avec les types de prescription
        ...
        this.jComboBox2.addItem("THERAPEUTIQUE");
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Nouvel acte infirmier");
    ...
    private void jLabel17MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel17MouseClicked
        if((this.jTextArea1.getText() != null )&&(this.jComboBox1.getSelectedItem() !=null)){
            //On ajoute la prescription au sejour et on met a jours la db
            String obs = this.jTextArea1.getText();
            int coef = Integer.parseInt(this.jTextField1.getText());
            ...
            Acte acteInf;
            if(this.jComboBox1.getSelectedItem().toString()=="actes infirmiers de soins"){
                if(this.jComboBox2.getSelectedItem().toString()=="DIAGNOSTIQUE"){
                    acteInf = new Acte(idFiche,Code.AIS,coef,obs,TypeActe.DIAGNOSTIQUE);
                }
                else{acteInf = new Acte(idFiche,Code.AIS,coef,obs,TypeActe.THERAPEUTIQUE);}
            }
            else {
                if(this.jComboBox1.getSelectedItem().toString()=="actes infirmiers"){
                    if(this.jComboBox2.getSelectedItem().toString()=="DIAGNOSTIQUE"){
                        acteInf = new Acte(idFiche,Code.AMI,coef,obs,TypeActe.DIAGNOSTIQUE);
                    }
                    ...
                    if(this.jComboBox1.getSelectedItem().toString()=="démarche des soins infirmiers"){
                        ...
                        if(this.jComboBox1.getSelectedItem().toString()=="prélèvement ponction veineuse"){
                            ...
                            else{acteInf = new Acte(idFiche,Code.KMB,coef,obs,TypeActe.THERAPEUTIQUE);}
                        }
                        else{
                            if(this.jComboBox2.getSelectedItem().toString()=="DIAGNOSTIQUE"){
                                acteInf = new Acte(idFiche,Code.SFI,coef,obs,TypeActe.DIAGNOSTIQUE);
                            }
                            else{acteInf = new Acte(idFiche,Code.SFI,coef,obs,TypeActe.THERAPEUTIQUE);}
                        }
                    }
                }
            }
            ArrayList<Acte> listActeInf = new ArrayList<>();
            listActeInf.add(acteInf);
            FicheDeSoins fiche = new FicheDeSoins(idFiche,listActeInf,null,null,this.p,dateP,this.numSej);
            ...
            DAOFactory.getActeDAO().create(acteInf);
